...
export type ContractContext = EthersContractContextV5<
  EasyDeployer,
  EasyDeployerMethodNames,
  EasyDeployerEventsContext,
  EasyDeployerEvents
>;
...
export type EasyDeployerEvents = undefined;
export interface EasyDeployerEventsContext {}
export type EasyDeployerMethodNames =
  | 'new'
