...
import { AssessmentContentRequest } from "./AssessmentDataStorage";
...
export interface CourseController {
     ...
     */
    "new"(addressBookAddress: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
    ...
    createNewCourse(
        ...
        assessmentContents: AssessmentContentRequest[],
