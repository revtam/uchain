...
export const REGSERVER_BASE_URL: string = process.env.REGSERVER_REMOTE_BASE_URL || "";
export const REGISTRATION_ENDPOINT: string = process.env.REGISTRATION_ENDPOINT || "";
export const FILESERVER_BASE_URL: string = process.env.FILESERVER_REMOTE_BASE_URL || "";
