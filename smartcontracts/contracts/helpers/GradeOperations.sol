...
library GradeOperations {
     ...
     */
    function isFirstBetterGrade(uint256 firstGrade, uint256 secondGrade) public pure returns (bool) {
     ...
     * compares two grades based on their value in the university's grading system.
     */
    function isFirstWorseGrade(uint256 firstGrade, uint256 secondGrade) public pure returns (bool) {
        return firstGrade > secondGrade;
    }
}
