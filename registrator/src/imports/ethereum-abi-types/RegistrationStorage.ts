...
export interface RegistrationStorage {
     ...
     * Type: function
     */
    getAllRegistrations(overrides?: ContractCallOverrides): Promise<RegistrationResponse[]>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    getRegistration(userAddress: string, overrides?: ContractCallOverrides): Promise<RegistrationResponse>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
