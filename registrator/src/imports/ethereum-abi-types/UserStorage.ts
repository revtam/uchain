...
export interface UserStorage {
     ...
     */
    getUserByAddress(userAddress: string, overrides?: ContractCallOverrides): Promise<UserResponse>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    getUserByUId(uId: BigNumberish, overrides?: ContractCallOverrides): Promise<UserResponse>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
