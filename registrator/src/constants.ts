...
export const RPC_NODE_URL: string = process.env.RPC_NODE_IP || "http://localhost:8545";
...
try {
    const privatKeyFile = fs.readFileSync(path.join(__dirname, "..", "secrets/registrator_private_key.txt"));
